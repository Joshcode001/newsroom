...
const [isLoading, setisLoading] = useState(false)
  ...
  const {country,category,page,icon, num} = useLocalSearchParams()
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.navbar}>
        <Navbar  ScrollRef={ScrollRef} router={router} Ref={ref} icon={econ} selectedC={con}  isC={cgory} isActive={false}/>
      </View>
