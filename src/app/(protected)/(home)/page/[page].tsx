import { Text, View ,StyleSheet,Pressable,TouchableOpacity, Modal,FlatList,ActivityIndicator,ScrollView} from "react-native";
import { Stack,useRouter,useLocalSearchParams } from "expo-router";
import React, {useState, useEffect,useRef} from "react";
import { data, Notifybar,Countrybar, CountryTag, Searchbar, Newsitem, Navbar } from '..'
...
const [isLoading, setisLoading] = useState(false)
  const {country, category, page, num}= useLocalSearchParams()
  const Ref = useRef('')
...
belect = page;
  ...
  <Navbar  router={router} isActive={isActive} ScrollRef={ScrollRef}
